...
export default function MatchPage({ id }) {
  ...
  return (
    <>
      <div className={cn("z-50 bg-gray-200 fixed top-0 flex items-center justify-start text-gray-500 border-gray-200 dark:text-gray-400 dark:border-gray-700 w-full")}>
        <MoveLeft className="w-10 h-7 text-start text-black cursor-pointer" onClick={() => router.back()} />
        <span className="text-sm text-black">Indian Premier League</span>
      </div>
